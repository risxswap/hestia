...
- [x] **Step 1: 写 HTTP 日志与 panic 恢复失败测试**
...
- [x] **Step 1: 写 LLM 各失败阶段与脱敏字段的失败测试**
...
- [x] **Step 1: 写 Agent Runner 与装配错误失败测试**
